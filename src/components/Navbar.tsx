    ...
    <>
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-container">
          ...
          <a href="https://www.linkedin.com/in/meyerur/" target="_blank" rel="noopener noreferrer" className="navbar-logo" onClick={closeMenu}>
            linkedin.com/in<span>/meyerur</span>
          </a>
          ...
          <div className={`navbar-links ${isMenuOpen ? 'open' : ''}`}>
            ...
            <a href="#colaboracion" onClick={closeMenu}>Tecnologias</a>
